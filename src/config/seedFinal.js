...
Phần mềm phải dễ dàng nâng cấp hoặc mở rộng.`
            },
            {
...
Phần mềm phải đảm bảo an toàn và chính xác.`
            },
            {
...
Do đó dự án không khả thi về mặt thời gian.`
            },
            {
...
REQUIREMENTS ENGINEERING -- PHÂN TÍCH YÊU CẦU PHẦN MỀM`
            },
        ]
    },
    {
...
Những mô tả trên chính là các yêu cầu của hệ thống.`
            },
            {
...
định rõ ràng hoặc thay đổi liên tục trong quá trình phát triển**.`
            },
            {
...
**Hiệu năng (Performance)** Hệ thống phải xử lý dữ liệu nhanh và đáp ứng nhiều người dùng cùng
lúc.

Ví dụ:
Hệ thống phải hỗ trợ tối đa 1000 người dùng truy cập đồng thời.

**Bảo mật (Security)** Dữ liệu và thông tin người dùng phải được bảo vệ.

Ví dụ:
Người dùng phải đăng nhập trước khi truy cập hệ thống.

**Khả năng sử dụng (Usability)** Hệ thống phải dễ sử dụng và thân thiện với người dùng.

**Độ tin cậy (Reliability)** Hệ thống phải hoạt động ổn định và ít xảy ra lỗi.
...
định các chức năng mà hệ thống cần cung cấp.`
            },
            {
...
hồi để điều chỉnh yêu cầu cho phù hợp hơn.`
            },
            {
...
lý, đối tác hoặc nhà cung cấp dịch vụ.`
            },
            {
...
khăn trong việc hiểu đúng yêu cầu.`
            },
            {
...
-   Làm cơ sở để thiết kế và kiểm thử phần mềm`
            },
            {
...
Postcondition: Thông tin người dùng được lưu vào cơ sở dữ liệu.`
            },
            {
...
Ví dụ:
Admin có thể kế thừa các chức năng cơ bản của User.`
            },
            {
...
trúc, dễ quản lý và dễ theo dõi tiến độ**.`
            },
            {
...
-   Dành nhiều thời gian hơn cho giai đoạn kiểm thử.`
            },
            {
...
ITERATIVE INCREMENTAL MODEL --- MÔ HÌNH LẶP LẠI, TĂNG THÊM`
            },
        ]
    },
    {
...
và cải thiện hệ thống qua từng vòng lặp.`
            },
            {
...
**1. Requirements Analysis** Xác định các yêu cầu cần thực hiện trong iteration hiện tại. Không
cần xác định toàn bộ yêu cầu ngay từ đầu như Waterfall.

**2. System Design** Thiết kế kiến trúc và các thành phần cần thiết để thực hiện các chức
năng trong iteration.

**3. Implementation** Lập trình các chức năng đã được xác định trong iteration.

**4. Testing** Kiểm thử các chức năng mới để đảm bảo hệ thống hoạt động đúng.

**5. Integration** Tích hợp phần chức năng vừa phát triển vào hệ thống tổng thể.

Sau khi hoàn thành một iteration, hệ thống sẽ có thêm chức năng mới và
quá trình phát triển tiếp tục với iteration tiếp theo.`
            },
            {
...
Mỗi iteration thường kéo dài từ 2 đến 4 tuần tùy vào quy mô dự án.`
            },
            {
...
tiến độ và đạt chất lượng mong muốn.`
            },
            {
...
-   Tạo checklist cho quá trình deployment`
            },
            {
...
**1. Individuals and interactions OVER processes and tools** → Con người và sự giao tiếp quan trọng hơn quy trình và công cụ.

**2. Working software OVER comprehensive documentation** → Phần mềm chạy được quan trọng hơn tài liệu quá chi tiết.

**3. Customer collaboration OVER contract negotiation** → Hợp tác với khách hàng quan trọng hơn việc đàm phán hợp đồng.

**4. Responding to change OVER following a plan** → Thích nghi với thay đổi quan trọng hơn việc bám chặt vào kế hoạch.

Điều này không có nghĩa là các yếu tố bên phải không quan trọng, nhưng
Agile ưu tiên các yếu tố bên trái hơn.`
            },
            {
...
linh hoạt và thích nghi tốt với sự thay đổi của dự án.`
            },
            {
...
-   Phải là phiên bản sản phẩm có thể phát hành được.`
            },
            {
...
Những tiêu chí này giúp User Story rõ ràng và dễ triển khai.`
            },
            {
...
(Risk Management)** trong suốt quá trình phát triển.`
            },
            {
...
trọng trong mỗi vòng phát triển.`
            },
            {
...
-   Hệ thống ngân hàng hoặc tài chính lớn`
            },
            {
...
Nếu cả hai yếu tố đều cao thì rủi ro sẽ rất nghiêm trọng.`
            },
            {
...
-   Nhà cung cấp dịch vụ gặp sự cố`
            },
            {
...
-   Contingency: chuẩn bị kế hoạch dự phòng`
            },
            {
...
-   Một lỗi nhỏ có thể chấp nhận được trong phiên bản đầu.`
            },
            {
...
-   Database xử lý lưu trữ dữ liệu`
            },
            {
...
Kiến trúc này phù hợp với hệ thống lớn và scalable.`
            },
            {
...
-   Tài liệu hóa thiết kế phần mềm`
            },
            {
...
Ở bước này ta tạo SQL schema và tối ưu hiệu năng.`
            },
            {
...
Trong thực tế quan hệ N:M thường được chuyển thành bảng trung gian.`
            },
            {
...
Điều này giúp tránh việc dữ liệu bị lặp lại không cần thiết.`
            },
            {
...
Ví dụ database cho hệ thống Plearn.
...
→ Vì vậy việc phát hiện lỗi sớm là rất quan trọng.`
            },
            {
...
| Delivery | Cuối dự án | Sau mỗi vòng | Sau mỗi Sprint | Cuối mỗi vòng |
...
| Suitable For | YC rõ ràng | YC chưa rõ | Startup | Hệ thống phức tạp |
...
- Chi phí và quản lý khá phức tạp`
            },
            {
...
Cách tiếp cận này gọi là Hybrid Development Model.`
            },
            {
...
- Sprint 2 tuần
- MVP sau 1--2 sprint
- Phát triển dựa trên feedback người dùng`
            },
            {
...
- Ít thay đổi
- Dễ estimate thời gian và chi phí`
            },
            {
                order_index: 9, title: `Case Study --- Chọn mô hình cho từng loại dự án — CASE STUDY 4: DỰ ÁN MÔN HỌC (Plearn)`, content: `━━━ Bài 2: Case Study --- Chọn mô hình cho từng loại dự án ━━━
CASE STUDY 4: DỰ ÁN MÔN HỌC (Plearn)

Dự án: Plearn --- Learning Management System
...
- Iterative Incremental đơn giản hơn`
            },
            {
...
- cải thiện collaboration giữa teams`
            },
            {
...
→ Cảnh báo khi hệ thống gặp vấn đề.`
            },
        ]
    },
];
...
async function seedCourses() {
    ...
    for (const c of COURSES) {
        ...
        for (const l of c.lessons) {
            await pool.query(
                `INSERT INTO lessons (course_id, title, content, order_index) VALUES ($1, $2, $3, $4)`,
                [course.id, l.title, l.content, l.order_index]
            );
...
async function seed() {
    try {
        log.title('Plearn — SEED TỪ TÀI LIỆU CNPM.DOCX');
